...
| Signed-receipt protocols and vendors (Agent Custos Code/Obsigna, Provenant, ProofAgent, AgentMint, Pipelock, veritrail, halo-record, CertNode, Asqav, IETF draft-sahu-agent-action-custos-code, ~19 total) | Hash-chained, signed action custos-code; tamper evidence; compliance | Claim-vs-log checking of any kind | Low on function; high on naming | github.com/JaredKlopstein/provenant/issues/6 |
...
## Implications
1. Rename: "Custos Code" now denotes signed action custos-code in this market and collides with AgentReceipt. Candidate: **Witness** (matches witnessed/unwitnessed vocabulary). See OPEN_QUESTIONS P4.
