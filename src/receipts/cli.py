...
def hooks_snippet() -> dict[str, object]:
    ...
    return {
        "hooks": {
            "PreToolUse": [{"matcher": "Bash", "hooks": [{"type": "command", "command": _hook_command("pre"), "timeout": 5}]}],
            "PostToolUse": [{"matcher": "", "hooks": [{"type": "command", "command": _hook_command("post-tool-use"), "timeout": 10}]}],
            "Stop": [{"matcher": "", "hooks": [{"type": "command", "command": _hook_command("stop"), "timeout": 120}]}],
        }
    }
